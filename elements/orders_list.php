...
<div class="col-md-2 text-center"><h5><?= t("View")?></h5></div>
            ...
            ?>
                <div class="row hidden-xs hidden-sm form-group">
                    ...
                    <a href="<?=URL::to('/account/orders/detail',$order->getOrderID())?>"><?= $order->getOrderID()?></a><?= $canend; ?>
                   ...
                   <div class="col-md-2 text-center"><a href="<?=URL::to('/account/orders/detail',$order->getOrderID())?>" class="ordr_det button" title="<?= t("View")?>"><?= t("View")?></a></div>
              </div>
              ...
              <div class="col-sm-12 col-xs-12">
                    ...
                    ?>  <a href="<?=URL::to('/account/orders/detail',$order->getOrderID())?>" class="pull-right"> View Detail</a> </div>
