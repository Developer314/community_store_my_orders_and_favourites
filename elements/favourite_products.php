          ...
          <div class="add_block">
            <form   id="store-form-add-to-cart-list-<?= $product->getID()?>">
              ...
              <div class="brk">  <a  href="<?= \URL::to(Page::getByID($product->getPageID()))?>" class="more_det"><?= t("More Details")?></a></div>
               ...
               <div class="brk"> <a data-add-type="list" data-product-id="<?= $product->getID()?>" href="javascript:void(0);" class="store-btn-add-to-cart <?= ($product->isSellable() ? '' : 'hidden');?> "><?=  ($btnText ? h($btnText) : t("Add to Cart"))?></a></div>
